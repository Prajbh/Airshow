...
void front()
{
	...
	output(300,130,"C BYRE GOWDA INSTITUTE OF TECHNOLOGY",fonts[3]);
	glColor3f(0.3,0.5,0.8);
	output(310,100,"DEPT. OF COMPUTER SCIENCE & ENGG.",fonts[0]);
	glColor3f(0.8,0.1,0.2);
	output(190,600,"GRAPHICAL IMPLEMENTATION OF AIRSHOW",fonts[2]);
	glColor3f(1.0,0.0,1.0);
	output(400,500,"SUBMITTED BY :",fonts[0]);
	output(400,350,"UNDER THE GUIDANCE OF :",fonts[0]);
	glColor3f(0.3,0.5,0.8);
	output(180,450,"SINDHU.S",fonts[3]);
	output(680,450,"UMA DEVI.M.V",fonts[3]);
	output(180,300,"Mr. MOHAMED SIDDIQUE PASHA",fonts[3]);
	output(640,300,"Ms. RADHA",fonts[3]);
	glColor3f(0.0,0.6,0.3);
	output(180,400,"(1CK10CS042)",fonts[0]);
	output(680,400,"(1CK10CS048)",fonts[0]);
